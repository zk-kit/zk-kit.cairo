...
> [!IMPORTANT]\
> Installation of [Scarb](https://docs.swmansion.com/scarb/) required for circuit tests.
...
- Cairo: <https://github.com/zk-kit/zk-kit.cairo>

## 📦 Packages

- [binary-merkle-root](./packages/binary_merkle_root/)
